...
public class Hooks {
    ...
    /*
       bunları calıstırmak ıcın runner calıstırmak yeterli
        ...
        Cucumber'da secim sansimiz yok eger stepdefinitions package'i icinde
    ...
    public void tearDown(Scenario scenario){
        ...
        if (scenario.isFailed()) {
            ...
            //senaryo failed olursa fotocekip driver a yukluyor
        }
        Driver.quitDriver();
    }
}
