...
@ConfigurationParameter(key = Constants.PLUGIN_PROPERTY_NAME,value = "pretty, html:target/cucumber-report/webUniversityTesti.html")
...
public class Runner {
     ...
     /*
        ...
        Istedigimiz class'lari belirlemek, calisan class'lara rapor eklemek
